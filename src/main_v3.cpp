...
int main(int argc, char* argv[]) {
  ...
  std::cout << "HashChainTable Generator (Implementation 3)" << std::endl;
  ...
  // Create bucket manager V3
  hashchain::BucketManagerV3 bucketManager(outputDir, MEMORY_LIMIT_MB);
  ...
  std::cout << "Effective nonce size used: " << bucketManager.getEffectiveNonceSize() << " bytes"
            << std::endl;
